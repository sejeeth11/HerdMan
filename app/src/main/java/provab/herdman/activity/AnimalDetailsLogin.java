 ...
 */
public class AnimalDetailsLogin extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.loginButton:
                ...
                Intent intent = new Intent(AnimalDetailsLogin.this, AnimalMainActivity.class);
                intent.putExtra("Hint",flag);
