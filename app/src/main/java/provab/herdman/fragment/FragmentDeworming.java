 ...
 */
public class FragmentDeworming extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v=inflater.inflate(R.layout.fragment_deworming, container, false);
        findViews(v);
        return v;
    }
        ...
        vaccineSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for(int i=0;i<arr.length;i++){
                    ...
                    DatabaseHelper.getDatabaseHelperInstance(getActivity()).Insert_Deworming(arr[i],vaccinDate.getText().toString(),disease.getText().toString(),vaccineBrand.getText().toString(),batchNumber.getText().toString(),dose.getText().toString(),"",route.getText().toString(),insem_text.getText().toString());
